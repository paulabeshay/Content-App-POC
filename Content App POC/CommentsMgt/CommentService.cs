...
namespace Content_App_POC.CommentsMgt
{
    public class CommentService : ICommentService
    {
        ...
        public async Task SetStatusRecursiveAsync(Guid commentId, CommentStatusEnum status, string modifiedBy)
        {
            await _repository.SetStatusRecursiveAsync(commentId, status, modifiedBy);
        }
